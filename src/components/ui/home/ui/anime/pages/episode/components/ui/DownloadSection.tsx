    ...
    return (
        <div>
            <button
                ...
                className="bg-card-bg/50 backdrop-blur-sm p-4 rounded-3xl border border-card-border/50 shadow-xl hover:shadow-2xl transition-all duration-300 flex gap-4 w-full items-center justify-center"
            >
                ...
                {isModalOpen && (
                    ...
                    >
                        <motion.div
                            ...
                            className="bg-background backdrop-blur-sm rounded-2xl p-6 md:p-8 border border-card-border shadow-lg w-full max-w-6xl max-h-[90vh] overflow-y-auto"
