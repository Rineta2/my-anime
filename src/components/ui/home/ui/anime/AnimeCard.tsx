...
export default function AnimeCard({ anime, index }: AnimeCardProps) {
    return (
        <Link
            ...
            className="group bg-background/60 backdrop-blur-md rounded-xl sm:rounded-2xl overflow-hidden shadow-lg transition-all duration-500 hover:shadow-2xl hover:-translate-y-1 border border-border-color/50 hover:border-primary/50"
        >
