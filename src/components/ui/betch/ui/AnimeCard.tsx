...
export default function AnimeCard({ anime, index }: AnimeCardProps) {
    return (
        <Link href={anime.href}
            className="group relative bg-background/80 backdrop-blur-lg rounded-2xl overflow-hidden shadow-lg transition-all duration-300 hover:shadow-2xl hover:-translate-y-1 border border-border-color/30 hover:border-purple-500/50 hover:bg-background/90"
        >
            <motion.div
            ...
            <motion.div
                ...
                className="p-4 sm:p-5 lg:p-6 flex flex-col gap-3"
            >
