        ...
        <dialog id="category_modal" className="modal">
            <div className="fixed inset-0 bg-slate-900/90 backdrop-blur-sm z-50 overflow-y-auto">
                <div className="flex items-center justify-center min-h-screen p-4">
                    <div className="bg-[var(--card-bg)] rounded-3xl shadow-2xl w-[90%] max-w-2xl p-8">
                        {/* Modal Header */}
                        <div className="flex items-center justify-between mb-8">
                            ...
                            <button
                                ...
                                className="p-2 hover:bg-[var(--border-color)] rounded-xl transition-colors duration-200"
                            >
                        ...
                        <form onSubmit={handleSubmit} className="space-y-8">
                            ...
                            <div className="bg-[var(--card-bg)] rounded-2xl p-6 shadow-sm border border-[var(--border-color)] hover:shadow-md transition-shadow">
                                <div className="flex items-center gap-3 mb-6">
                                    <div className="p-2 bg-[var(--border-color)] rounded-lg">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm">Enter the basic information for your category</p>
                                    </div>
                                </div>
                                ...
                                <div className="space-y-4">
                                    <div className="flex flex-col gap-2">
                                        ...
                                        <input
                                            ...
                                            className="w-full px-4 py-2.5 bg-[var(--card-bg)] border border-[var(--border-color)] rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
                            ...
                            <div className="flex justify-end gap-3 pt-4 border-t border-[var(--border-color)]">
                                <button
                                    type="button"
                                    className="px-4 py-2.5 hover:bg-[var(--border-color)] rounded-xl transition-all duration-200 font-medium inline-flex items-center gap-2"
                                ...
                                <button
                                    type="submit"
                                    className="px-4 py-2.5 bg-primary hover:bg-primary/90 text-white rounded-xl shadow-sm transition-all duration-200 disabled:opacity-50 font-medium inline-flex items-center gap-2"
                                    disabled={isSubmitting}
                                >
                                    {isSubmitting ? (
                                        <>
