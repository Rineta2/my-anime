    ...
    return (
        <section className='min-h-full p-4 md:p-6'>
            <motion.div
                ...
                className="bg-[var(--card-bg)] rounded-2xl shadow-md border border-[var(--border-color)] p-6 mb-8 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4"
            >
                <motion.div
                ...
                <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    className="w-full sm:w-auto px-6 py-3 bg-gradient-to-r from-indigo-600 to-indigo-700 hover:from-indigo-700 hover:to-indigo-800 text-white rounded-xl transition-all duration-300 flex items-center justify-center gap-2 shadow-md"
                    onClick={() => {
            ...
            <motion.div
                ...
                animate={{ y: 0, opacity: 1 }}
                transition={{ duration: 0.5, delay: 0.4 }}
                className="bg-[var(--card-bg)] rounded-2xl shadow-md border border-[var(--border-color)] p-6 mb-8"
            >
                <div className="flex flex-col md:flex-row gap-4">
                    <div className="flex-1">
                        <div className="relative">
                            <input
                                ...
                                className="w-full px-4 py-3 pl-10 bg-[var(--card-bg)] border border-[var(--border-color)] rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent shadow-sm"
                            />
                            <svg
                    ...
                    <div className="flex flex-col sm:flex-row gap-3">
                        <select
                            ...
                            className="px-4 py-3 bg-[var(--card-bg)] border border-[var(--border-color)] rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent shadow-sm"
                        >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {filteredArticles.map((article) => (
                    <div key={article.id} className="group bg-[var(--card-bg)] rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden border border-[var(--border-color)]">
                        <div className="relative">
                            <Image
            ...
            {filteredArticles.length === 0 && (
                <motion.div
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                    className="text-center py-12 bg-[var(--card-bg)] rounded-xl shadow-md border border-[var(--border-color)]"
                >
                ...
                <div className="fixed inset-0 bg-slate-900/90 backdrop-blur-sm z-50 flex items-center justify-center p-4">
                    ...
                    >
                        ...
                        <div className="flex justify-end gap-4">
                            ...
                            <button
                                className="px-5 py-2.5 bg-red-500 hover:bg-red-600 text-white rounded-xl transition-all duration-300 font-medium shadow-sm"
                                    ...
                                    <div className="flex-1 flex items-center gap-2">
                                        <div className="flex-1 flex items-center px-4 py-1.5 bg-gray-900/50 rounded-lg border border-gray-700/50">
                                            <div className="flex items-center gap-2 text-gray-400 text-sm">
                                                ...
                                                <span className="opacity-75 truncate">https://anime-indo.vercel.app/articles/{viewArticle.slug}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
