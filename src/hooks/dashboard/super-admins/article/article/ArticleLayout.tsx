...
import { Article } from '@/hooks/dashboard/super-admins/article/article/types/schema'
...
import { useArticles } from '@/hooks/dashboard/super-admins/article/article/hooks/useArticles'

import ArticleCard from '@/hooks/dashboard/super-admins/article/article/components/ArticleCard'

import SearchFilter from '@/hooks/dashboard/super-admins/article/article/components/SearchFilter'

import DeleteModal from '@/hooks/dashboard/super-admins/article/article/components/DeleteModal'

import ViewModal from '@/hooks/dashboard/super-admins/article/article/components/ViewModal'
