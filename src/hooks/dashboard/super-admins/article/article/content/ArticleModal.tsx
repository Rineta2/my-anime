...
export default function ArticleModal({ article, onClose, onSuccess }: ArticleModalProps) {
    ...
    const renderAuthorField = () => (
        <div className="bg-[var(--card-bg)] rounded-xl p-6 shadow-sm border border-[var(--border-color)] hover:shadow-md transition-all duration-300">
            <div className="flex items-center gap-3 mb-8">
                ...
                <h4 className="font-semibold text-lg ">Author Information</h4>
            </div>
                    ...
                    <div className="form-control">
                        ...
                        <div className="relative">
                            <input
                                ...
                                className="w-full px-4 py-3 rounded-xl border border-[var(--border-color)] bg-[var(--card-bg)] cursor-not-allowed focus:ring-0"
                                disabled
                            />
                        ...
                        <p className="mt-2 text-xs">This information is pulled from your profile and cannot be edited here.</p>
                    </div>

                    <div className="form-control">
                        <label className="text-sm font-medium mb-2">Access Level</label>
                        <div className="relative">
                            <input
                                type="text"
    ...
    return (
        <dialog id="article_modal" className="modal">
            <div className="modal-box bg-[var(--card-bg)] max-w-6xl p-0 overflow-hidden">
                {/* Modal Header */}
                <div className="sticky top-0 bg-[var(--card-bg)] border-b border-[var(--border-color)] px-6 py-4 flex justify-between items-center z-10">
                    ...
                    <button
                        onClick={handleClose}
                        className="btn btn-circle btn-ghost btn-sm hover:bg-[var(--border-color)] transition-colors"
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div className="form-control">
                                        ...
                                        <input
                                            type="text"
                                            className="input w-full bg-[var(--card-bg)] border-[var(--border-color)] focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all rounded-lg"
                                            value={title}
                                    ...
                                    <div className="form-control">
                                        <label className="text-sm font-medium mb-1.5">Slug</label>
                                        <input
                                            type="text"
                                            className="input w-full bg-[var(--card-bg)] border-[var(--border-color)] focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all rounded-lg"
                                            value={slug}
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div className="form-control">
                                        ...
                                        <textarea
                                            className="textarea w-full bg-[var(--card-bg)] border-[var(--border-color)] focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all rounded-lg h-24 resize-none"
                                            value={description}
                                    ...
                                    <div className="form-control">
                                        <label className="text-sm font-medium mb-1.5">Publish Status</label>
                                        <select
                                            className="select w-full bg-[var(--card-bg)] border-[var(--border-color)] focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all rounded-lg"
                                            value={publishStatus}
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="bg-[var(--card-bg)] rounded-xl p-6 shadow-sm border border-[var(--border-color)]">
                                <div className="flex items-center gap-3 mb-6">
                                    ...
                                    <h4 className="font-semibold text-lg ">Thumbnail</h4>
                                </div>
                                    ...
                                    {thumbnailPreview ? (
                                        <div className="relative rounded-lg overflow-hidden group">
                                            ...
                                            <div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-all flex items-center justify-center gap-3">
                                                <button
                                                    type="button"
                                                    className="btn btn-sm btn-circle bg-[var(--card-bg)] hover:bg-[var(--border-color)] border-0"
                                                    onClick={() => {
                                        ...
                                        <div className="relative border-2 border-dashed border-[var(--border-color)] rounded-lg hover:border-green-500 transition-all">
                                            <input
                                                id="thumbnail-input"
                                                type="file"
                                                accept="image/*"
                                            ...
                                            <div className="flex flex-col items-center justify-center h-[200px] p-4">
                                                ...
                                                <p className="text-xs mt-1">Drag or click to upload</p>
                                            </div>
                                        </div>
                                    )}
                                </div>
                            ...
                            <div className="bg-[var(--card-bg)] rounded-xl p-6 shadow-sm border border-[var(--border-color)]">
                                <div className="flex items-center gap-3 mb-6">
                                    ...
                                    <h4 className="font-semibold text-lg ">Categories & Category Articles</h4>
                                </div>
                                ...
                                <div className="space-y-6">
                                    <div className="form-control">
                                        ...
                                        <select
                                            className="select w-full bg-[var(--card-bg)] border-[var(--border-color)] focus:border-purple-500 focus:ring-1 focus:ring-purple-500 transition-all rounded-lg"
                            ...
                            <div className="form-control overflow-hidden">
                                <div className="border rounded-lg bg-white">
                                    <ReactQuill
                                        ...
                                        className="[&_.ql-toolbar]:sticky [&_.ql-toolbar]:top-0 [&_.ql-toolbar]:z-10 [&_.ql-toolbar]:bg-white [&_.ql-editor]:min-h-[300px] [&_.ql-editor]:bg-[var(--card-bg)] [&_.ql-editor]:border-[var(--border-color)] [&_.ql-editor]:rounded-lg [&_.ql-editor]:text-[var(--text-color)]"
                ...
                {/* Modal Footer */}
                <div className="sticky bottom-0 bg-[var(--card-bg)] border-t border-[var(--border-color)] px-6 py-4 flex justify-end gap-3 z-10">
                    <button
                        type="button"
                        onClick={handleClose}
                        className="btn btn-ghost hover:bg-[var(--border-color)] transition-colors"
                        disabled={loading}
                    >
                        Cancel
                    </button>
