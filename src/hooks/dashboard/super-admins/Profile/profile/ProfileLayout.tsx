...
import ProfileSkelaton from '@/hooks/dashboard/super-admins/Profile/profile/ProfileSkelaton';
    ...
    return (
        ...
        >
            <motion.div
                ...
                className="bg-[var(--card-bg)] rounded-2xl shadow-sm border border-[var(--border-color)] p-6 mb-8"
            >
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    ...
                    {!isEditing && (
                        <button
                            onClick={handleEdit}
                            className="w-full sm:w-auto px-6 py-3 bg-gradient-to-r from-indigo-600 to-indigo-700 hover:from-indigo-700 hover:to-indigo-800 text-white rounded-xl transition-all duration-300 flex items-center justify-center gap-2 shadow-sm hover:shadow-lg transform hover:-translate-y-0.5"
                        >
            ...
            <motion.div
                ...
                className="bg-[var(--card-bg)] rounded-3xl shadow-lg border border-[var(--border-color)] backdrop-blur-xl p-8"
            >
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                        ...
                        >
                            <div className="relative group">
                                <div className="w-48 h-48 rounded-full overflow-hidden ring-4 shadow-xl">
                                    {profile.photoURL ? (
                                        <Image
                                ...
                                {isEditing && (
                                    <>
                                        ...
                                        <label
                                            ...
                                            className="inline-flex items-center gap-2 px-6 py-3 text-indigo-600 
                                                rounded-xl transition-all duration-300 font-medium 
                                                border-2 border-[var(--border-color)] hover:border-[var(--border-color)] shadow-sm
                                                active:scale-95"
                                        >
                            ...
                            <div className="space-y-6">
                                {[
                                    ...
                                    <motion.div
                                        ...
                                        whileHover={{ scale: 1.02 }}
                                        className="group p-6 bg-[var(--card-bg)] rounded-2xl hover:bg-[var(--card-bg)] transition duration-300 
                                            hover:shadow-lg border border-[var(--border-color)]"
                                    >
                                        ...
                                        <div className="mt-1">
                                            {field.isStatus ? (
                                                ...
                                                <input
                                                    ...
                                                    className="w-full p-3 bg-[var(--card-bg)] border-2 border-[var(--border-color)] rounded-xl focus:ring-2 
