...
import TransactionUnpaidDetails from '@/hooks/dashboard/super-admins/transaction/unpaid/TransactionUnpaidDetails'

import { Transaction } from '@/hooks/dashboard/super-admins/transaction/transaction/types/transaction'

import TransactionUnpaidSkeleton from '@/hooks/dashboard/super-admins/transaction/transaction/TransactionSkeleton'
...
export default function TransactionLayout() {
  ...
  useEffect(() => {
    ...
    const q = query(transactionsRef, where('proofOfPayment', '==', null))
    ...
    return (
      ...
      >
        ...
        <p className="text-center max-w-md">
          There are currently no unpaid transactions in the system. Check back later for updates.
        </p>
      </motion.div>
    )
  }
    ...
    <section className='min-h-screen'>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {transactions.map((transaction) => (
          <TransactionUnpaidDetails key={transaction.id} transaction={transaction} />
        ))}
      </div>
    </section>
  )
