...
import TransactionDetails from '@/hooks/dashboard/super-admins/transaction/transaction/TransactionDetails'
    ...
    return (
      ...
      >
        ...
        <p className="text-center max-w-md">
          There are currently no transactions in the system. Check back later for updates.
        </p>
      </motion.div>
    )
  }
