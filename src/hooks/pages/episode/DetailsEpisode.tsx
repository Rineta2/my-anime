...
import { getEpisodeData } from '@/hooks/pages/episode/lib/FetchEpisode';

import { Episode, EpisodePageProps } from '@/hooks/pages/episode/types/types';

import DetailsEpisodeSkeleton from "@/hooks/pages/episode/DetailsEpisodeSkelaton";

import HeroSection from '@/hooks/pages/episode/components/ui/HeroSection';

import NavigationButtons from '@/hooks/pages/episode/components/ui/NavigationButtons';

import RecommendedEpisodes from '@/hooks/pages/episode/components/ui/RecommendedEpisodes';

import RelatedMovies from '@/hooks/pages/episode/components/ui/RelatedMovies';

import GenresSection from '@/hooks/pages/episode/components/ui/GenresSection';

import SynopsisSection from '@/hooks/pages/episode/components/ui/SynopsisSection';

import { useAuth } from '@/utils/context/AuthContext';

import { addToViewHistory } from '@/hooks/pages/episode/components/utils/history';
