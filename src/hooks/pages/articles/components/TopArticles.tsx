  ...
  return (
    ...
    >
      <Link href={`/articles/${article.slug}`}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 place-items-center bg-[var(--card-bg)] border border-[var(--border-color)] rounded-3xl p-6 shadow-sm transition-all duration-300">
          <motion.div
          ...
          <div className="flex flex-col gap-6">
            ...
            <motion.h2
              ...
              className="text-2xl lg:text-4xl font-bold line-clamp-3"
            >
              {article.title}
            </motion.h2>
            <motion.p
              ...
              className="text-base text-[(--text-secondary)] line-clamp-3"
            >
              {article.description}
            </motion.p>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col">
                  <p className="text-text text-md">{article.author.name}</p>
